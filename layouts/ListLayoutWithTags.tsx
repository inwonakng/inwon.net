...
export default function ListLayoutWithTags({
  ...
  const displayPosts = (
    initialDisplayPosts.length > 0
      ? !searchValue ? initialDisplayPosts : filteredPosts
      : !searchValue ? posts : filteredPosts
  )
    ...
    <>
      <div>
        <div className="pb-4 pt-6">
          <h1 className="text-3xl font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 mb-4">
            {title}
          </h1>
