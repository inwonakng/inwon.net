...
images: 
  - /static/images/clean-my-web/youtube-screenshot.png
---

![](/static/images/blog/clean-my-web/youtube-screenshot.png)
...
The usage of Ethereum is not ideal in this project. 
We want this to be a data storage for ML models, but storing large amounts of data on the blockchain is not ideal, so for real life usage, it will need to make use of an alternative storage.
