...
It's best if you know how to use some form of virtual environments (you can refer to [this post](/blog/python-dependency-management) if you need a refersher).
It's not necessary, but it is stronly recommended.
