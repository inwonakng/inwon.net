...
images: 
  - /static/images/blog/remote-computing-tips/vscode-remote-ssh.png
---
...
The ssh keys is unique to your machine and can be used to enter other machines that you are authorized to.
...
To add it to your github account, you can go do you settings (in the main page, press your account's picture and press settings),
and find the menu for SSH keys under the 'Access' section.
...
If you need to check your public key later, you can use the `cat` command to display it in the terminal,
e.g. `cat ~/.ssh/id_rsa.pub` (this is if you followed all the default settings in the keygen process).

#### Adding your key to remote machines 
...
Host {SOME_UNIQUE_NAME}
    ...
    LocalForward {LOCAL_PORT_YOU_WANT} 127.0.0.1:{REMOTE_PORT_TO_FORWARD}
    User {YOUR_USERNAME}
```
